...
function lightMode(){
  ...
  skillCardFront.setAttribute('style', 'background-image: url(/assets/img/skill-card-fe-light.png);"')
  skillCardBack.setAttribute('style', 'background-image: url(/assets/img/skill-card-be-light.png);"')
  skillCardSoft.setAttribute('style', 'background-image: url(/assets/img/skill-card-soft-light.png);"')
